  ...
  <Teleport to="body">
    <Transition name="fade">
      ...
      >
        <div
          class="result-card"
          :class="isCorrect ? 'result-card--correct' : 'result-card--incorrect'"
        >
          ...
          <p class="text-gray-400 text-sm mb-3">
            <strong class="text-white">{{ pokemonName }}</strong> is:
          </p>

          <div class="flex flex-wrap justify-center gap-1.5 mb-3">
            <span
              v-for="t in correctTypes"
              :key="t"
          ...
          <p class="text-xs text-gray-500 mb-3">
            Score: <strong class="text-white">{{ score }}</strong> / {{ round }}
          </p>
